...
from data_management_app.config.root_dir import *
from data_management_app.utils.pandas_utils import read_from_csv_to_df


@pytest.fixture(scope='module')
def main_table():
    return read_from_csv_to_df(CSV_DATA_MAIN_TABLE_SMALL_DATA)

@pytest.fixture(scope='module')
def second_table():
    return read_from_csv_to_df(CSV_DATA_SECOND_TABLE_SMALL_DATA)
